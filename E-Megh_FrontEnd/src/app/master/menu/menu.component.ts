...
export class MenuComponent extends UnSubscriber implements OnInit {
  ...
  ngOnInit(): void {
    ({ DEFAULT_COLUMNS: this.displayedColumns, DEFAULT_TABLE_COLUMNS: this.defaultTableColumns } = this._GlobalService.tableColumnReformater(DEFAULT_COLUMNS.MENU, DEFAULT_TABLE_COLUMNS.MENU));
    this.GetMenudata();
  }
