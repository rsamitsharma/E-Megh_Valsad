...
import { ReadingLocationDialogComponent } from "./reading-location-dialog/reading-location-dialog.component";
...
@Component({
  selector: "app-reading-location",
  templateUrl: "./reading-location.component.html",
  styleUrls: ["./reading-location.component.scss"],
})
export class ReadingLocationComponent extends UnSubscriber implements OnInit {
  ...
  openDialog(id?: number) {
    ...
    const dialogRef = this.dialog.open(ReadingLocationDialogComponent, dialogConfig);
