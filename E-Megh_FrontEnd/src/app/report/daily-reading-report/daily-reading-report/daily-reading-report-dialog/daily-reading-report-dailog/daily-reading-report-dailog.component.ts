...
@Component({
  selector: "app-daily-reading-report-dailog",
  templateUrl: "./daily-reading-report-dailog.component.html",
  styleUrls: ["./daily-reading-report-dailog.component.scss"],
})
export class DailyReadingReportDailogComponent extends UnSubscriber implements OnInit {
  constructor(public datepipe: DatePipe, @Inject(MAT_DIALOG_DATA) public data: any, private _MasterService: MasterService, public _GlobalService: GlobalService, private toastr: ToastrService, private _dialogRef: MatDialogRef<DailyReadingReportDailogComponent>) {
    super();
